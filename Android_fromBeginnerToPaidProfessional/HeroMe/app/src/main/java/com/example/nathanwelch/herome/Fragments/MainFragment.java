...
public class MainFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //we moved this up here as opposed to having it in the return because we needed
        //to use stuff from the View
        ...
        powersBtn = (Button) view.findViewById(R.id.powersBtn);
        ...
        powersBtn.setEnabled(false);
        powersBtn.getBackground().setAlpha(128);

        // Inflate the layout for this fragment -> returns a view (screen)
        return view;
    }

    @Override
    public void onClick(View v) {
        powersBtn.setEnabled(true);
        powersBtn.getBackground().setAlpha(255);

        Button btn = (Button) v; //casting the incoming View as a Button
        int leftDrawable = 0;

        accidentBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.lightning, 0, R.drawable.itemunselected, 0);
        mutationBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.atomic, 0, R.drawable.itemunselected, 0);
    ...
    //need code that will not only set the checkmark drawables but get rid of any existing ones on other buttons
        //this sets the drawable of the button selected (button clicked)
